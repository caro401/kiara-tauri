...
export type NetworkNode = {
	...
	_label: string;
	_count_edges: number;
	_count_edges_multi: number;
	_in_edges: number;
	_in_edges_multi: number;
	_out_edges: number;
	_out_edges_multi: number;
	id: string;
};
...
export type NetworkMetadata = {
	...
	properties_by_graph_type: {
		directed: GraphTypeData;
		directed_multi: GraphTypeData;
		undirected: GraphTypeData;
		undirected_multi: GraphTypeData;
	};
	number_of_self_loops: number;
};
